...
CLASSES: dict[str, ClassDef] = {
    "warrior": ClassDef(
        ...
        hp_growth=13.63, atk_growth=1.94, def_growth=1.94,
    ...
    "mage": ClassDef(
        ...
        hp_growth=8.2, atk_growth=2.73, def_growth=1.83,
    ...
    "rogue": ClassDef(
        ...
        hp_growth=11.88, atk_growth=2.17, def_growth=1.08,
    ...
    "paladin": ClassDef(
        ...
        hp_growth=10.5, atk_growth=1.91, def_growth=1.91,
        skill_key="divine_shield", skill_name="Divine Shield",
        skill_desc="Starts every fight with a shield absorbing 20% of max HP, and heals 15% "
                    "of max HP the first time you drop below 30%.",
    ),
    "necromancer": ClassDef(
        ...
        hp_growth=8.47, atk_growth=2.82, def_growth=1.88,
    ...
    "ranger": ClassDef(
        ...
        hp_growth=13.12, atk_growth=2.18, def_growth=1.09,
    ...
    "berserker": ClassDef(
        ...
        hp_growth=6.76, atk_growth=3.87, def_growth=0.97,
    ...
    "monk": ClassDef(
        ...
        hp_growth=9.93, atk_growth=2.49, def_growth=1.49,
    ...
    "druid": ClassDef(
        ...
        hp_growth=9.88, atk_growth=2.47, def_growth=1.48,
