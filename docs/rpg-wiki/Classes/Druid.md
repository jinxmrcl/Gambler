...
## Skill
**Regrowth** — After every exchange, recovers 4% of missing HP.

Unlike Paladin's Lay on Hands (a single threshold-triggered heal), Regrowth has no once-per-fight limit or HP threshold — it ticks continuously for the whole fight.
